...
import algoritm.matrix.KnapsackTotalPrice;
import algoritm.matrix.KnapsackWithObject;
...
class KnapsackTest {
  ...
  void selectStockObject(int saving, List<Stock> stocks, int expectedResult) {

    var result = algoritm.Knapsack.selectStock(saving, stocks);
